...
def adicionar_produto(usuario, usuarios, id_, usuarios_logados, produtos, ids):
    if usuario and id_ in usuarios_logados: ####alterar depois
        print('SEU ID: ', id_)
        nome = input('Nome produto: ')
        tipo = input('Tipo: ')
        produtos['nome'].append(nome)
        produtos['tipo'].append(tipo)
        # produtos['alter_id'].append(id_)
        #####
        n = 0
        produtos['descricao'].append(n)
        produtos['quem_recebe'].append(n)
        produtos['quantidade'].append(n)
        produtos['id_produto'].append(id_)
